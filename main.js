...
createListenButton = () => {
  ...
  userMusicControls.appendChild(listenButton);
...
styleFeedback = (score) => {
  if (score < 50) {
    feedbackZone1.style.fontSize = '20px';
    feedbackZone1.style.color = 'black';
  } else if (score < 75) {
    feedbackZone1.style.fontSize = '20px';
    feedbackZone1.style.color = 'green';
  } else if (score < 100) {
    feedbackZone1.style.fontSize = '25px';
    feedbackZone1.style.color = 'green';
  } else if (score === 100) {
    feedbackZone1.style.fontSize = '28px';
    feedbackZone1.style.color = 'green';
  }
}
...
removeStartButton = () => {
  ...
  let timeOrButton = document.getElementById('time-or-button');
  let timeSpan = document.createElement('span');
  timeSpan.setAttribute('id', 'time-span');
  timeOrButton.removeChild(startButton);
  timeOrButton.appendChild(timeSpan);
  return timeSpan;
}

// replaces remaining time with the start button after each round
createStartButton = () => {
  ...
  document.getElementById('time-or-button').removeChild(timeSpan);
  document.getElementById('time-or-button').appendChild(startButton);
}
